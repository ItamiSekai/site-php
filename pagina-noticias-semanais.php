...
<head>
  ...
  <title>Notícias Semanais - MusicData</title>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <img src="path/to/image3.jpg" alt="Imagem da Notícia 1" class="img-fluid mb-3">
                                <p>Conteúdo da notícia semanal 1. Análises e comentários sobre os eventos da semana.</p>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <img src="path/to/image4.jpg" alt="Imagem da Notícia 2" class="img-fluid mb-3">
                                <p>Conteúdo da notícia semanal 2. Resumos e informações relevantes do mundo da música.</p>
                            </div>
                        </div>
                    </div>
